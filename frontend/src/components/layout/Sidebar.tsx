import { SlidersHorizontal, Activity, Server, List, Terminal, Code, Box, Layers, HardDriveDownload, Database, Shield, Microscope, ShieldAlert, Package, Network, Radio, Key, FileText, GitCommit, TrendingUp, HardDrive } from 'lucide-react';
